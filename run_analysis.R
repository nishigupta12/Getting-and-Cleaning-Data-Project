...
# Step 8 - Create initial and second tidy data sets
TotalData_FirstTidySet <- melt(TotalData, id = c("subject", "activity"))
TotalData_SecondTidySet <- dcast(TotalData_FirstTidySet, subject + activity ~ variable, mean)

# Step 9 - View second data set and create tidy data set file in txt format
View(TotalData_SecondTidySet)
write.table(TotalData_SecondTidySet, file = "TidySet.txt", row.names = FALSE)
